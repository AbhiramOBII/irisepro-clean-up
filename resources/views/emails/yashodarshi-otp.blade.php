...
<head>
    ...
    <title>Yashodarshi Login OTP</title>
    <style>
        body {
...
<body>
    <div class="header">
        ...
        <h1>Yashodarshi Login OTP</h1>
    </div>

    <p>Hello {{ $name }},</p>

    <p>You have requested to login to your Yashodarshi account. Please use the following One-Time Password (OTP) to complete your login:</p>
